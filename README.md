...
* K-Means clustering for influencer segmentation
...
* User authentication
* Analytics dashboard
Dataset: https://www.kaggle.com/datasets/navya7777/indian-micro-influencer-dataset-for-rec-sys/data
